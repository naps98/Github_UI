class GithubProjectCommitResponse {
  String? sha;
  String? nodeId;
  Commits? commit;
  String? url;
  ...
  GithubProjectCommitResponse.fromJson(Map<String, dynamic> json) {
    sha = json['sha'];
    nodeId = json['node_id'];
    commit =
    json['commit'] != null ? new Commits.fromJson(json['commit']) : null;
    url = json['url'];
...
class Authors {
  ...
  Authors({this.name, this.email, this.date});
...
class Commiter {
  ...
  Commiter.fromJson(Map<String, dynamic> json) {
    login = json['login'];
    id = json['id'];
    nodeId = json['node_id'];
