class GithubRepoResponse {
  ...
  GithubRepoResponse({this.userResponse});

  GithubRepoResponse.fromJson(Map<String, dynamic> json) {
    if (json['user_response'] != null) {
      userResponse = <UserResponse>[];
      json['user_response'].forEach((v) {
        userResponse!.add(new UserResponse.fromJson(v));
      });
    }
  }
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.userResponse != null) {
      data['user_response'] =
          this.userResponse!.map((v) => v.toJson()).toList();
    }
    return data;
  }
}
